...
export interface MaterializedViewSchemaOptions extends SchemaOptionsBase {
  ...
  materializedQuery?: ((qb: SelectQueryBuilder<any>) => SelectQueryBuilder<any>) | string // Query used to define the materialized view, either as a function or a raw query string.
}
